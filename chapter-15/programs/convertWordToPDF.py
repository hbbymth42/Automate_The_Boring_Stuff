...
docObj = wordObj.Documents.Open(wordFilename) # This command will search the 'Documents' folder on Windows, please create the word document in the 'Documents' folder
